...
QuantForge is an independent research project building an execution-aware, regime-conditioned portfolio optimization system across 11 modular sub-projects (B0-B11).

**B0 Status:** ✅ **Complete** - Reproducible backtesting infrastructure with Docker containerization and professional logging.
...
# Run smoke test
python projects/b0_quantreprolab/smoke_backtest.py
```
